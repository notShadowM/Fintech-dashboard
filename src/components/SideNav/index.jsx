  ...
  return (
    <div className='navContainer'>
      ...
      <div className={`category ${first || "smallGap"}`}>
        <div className="categoryTitle" onClick={e => setFirst(prev => !prev)}>
          Payments <Arrow className={`arrow ${first || "closedArrow"}`}/>
        </div>
      ...
      <div className={`category ${second || "smallGap"}`}>
        <div className="categoryTitle" onClick={e => setSecond(prev => !prev)}>
          Commerce <Arrow className={`arrow ${second || "closedArrow"}`} />
        </div>
